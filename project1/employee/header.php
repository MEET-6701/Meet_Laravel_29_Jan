	...
	<div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
      ...
      <nav class="navbar navbar-inverse">
          <div class="navbar-header">
            ...
            <h1><a class="navbar-brand" href="../website/index"><span class="fa fa-area-chart"></span> Rent<span class="dashboard_text">My Car dashboard</span></a></h1>
          </div>
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="sidebar-menu">
              ...
              <li class="treeview">
                <a href="manage_car">
                <i class="fa fa-user"></i> <span> manage car </span>
                </a>
              </li>
              <!--end area-->
              ...
              <li class="treeview">
                ...
                <i class="fa fa-user"></i> <span> manage client </span>
                </a>
              </li>
              <!--end Clinet-->
					...
					<ul>
						<li class="dropdown profile_details_drop">
							...
							<ul class="dropdown-menu drp-mnu">
								...
								<li> <a href="log out"><i class="fa fa-sign-out"></i> Logout</a> </li>
							</ul>
						</li>
					</ul>
				</div>
